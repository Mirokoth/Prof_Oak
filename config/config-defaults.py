...
PYTHON_CMD = "python" # Python command depending on environment (python/python2/python3)
BOT_CMD_SYMBOL = "!" # Symbol prefix required for bot commands
BOT_TOKEN = "<insert discord api token>" # Discord API token
OWM_TOKEN = "<insert owm api token>" # Pyowm API token
